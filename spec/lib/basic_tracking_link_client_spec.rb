...
RSpec.describe BasicTrackingLinkClient do
  describe "Basic Tracking Link Client (development only tests)", :development_only_tests => true do 
    ...
    it 'returns nil when getting a tracking link' do
      post_request_body = 'This is a request body'
    ...
    it 'creates a basic tracking link (no URL shortening, no analytics and tracking_url = destination_url)' do
      tracking_link = nil
    ...
    it 'returns an empty array instead of the ClickMeter groups' do
      groups = 'groups'
    ...
    it 'returns an empty array instead of the ClickMeter domains' do
      domains = 'domains'
