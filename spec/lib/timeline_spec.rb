...
RSpec.describe Timeline do
  ...
  it 'builds a default timeline for an experiment' do
    ...
    expect(timeline.events[0].description).to eq('Trial Promoter will no longer allow messages to be generated. Trial Promoter will send messages to Buffer (up to a week in advance) for distribution to social networks.')
