class MessageTemplateImporter < Importer
  def post_initialize
    ...
    self.column_index_attribute_mapping = { 0 => 'content', 1 => 'platforms', 2 => 'hashtags', 3 => 'tag_list', 4 => 'promoted_website_url', 6 => 'experiment_variables', 7 => 'original_image_filenames' }
  end
