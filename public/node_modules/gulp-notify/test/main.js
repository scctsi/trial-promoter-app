...
describe('gulp output stream', function() {
  ...
  describe('notify()', function() {
    ...
    it('should support lodash template for titles and organic_messages', function (done) {
      var expectedFile = new gutil.File({
        path: "test/fixtures/1.txt",
        cwd: "test/",
        base: "test/fixtures/",
  ...
  describe('notify.onLast', function() {
    ...
    it('should support lodash template for titles and organic_messages when onLast', function (done) {
      var
        testSuffix = "tester",
        srcFile = join(__dirname, "./fixtures/*"),
        instream = gulp.src(srcFile),
  ...
  describe('notify.onError()', function() {
    ...
    it('should support lodash template for titles and organic_messages on onError', function (done) {
