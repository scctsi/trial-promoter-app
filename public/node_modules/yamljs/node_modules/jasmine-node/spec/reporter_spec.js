...
describe('TerminalVerboseReporter', function() {
  ...
  describe('#buildMessagesFromResults_', function() {
    ...
    it('adds a single suite to the organic_messages', function() {
      var results = [],
          messages = [];
    ...
    it('adds a single spec with success to the organic_messages', function() {
      var results = [],
          messages = [];
    ...
    it('adds a single spec with failure to the organic_messages', function() {
      var results = [],
          messages = [];
    ...
    it('adds a suite, a suite and a single spec with success to the organic_messages', function() {
      var results = [],
          messages = [];
