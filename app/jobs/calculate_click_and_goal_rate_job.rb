class CalculateClickAndGoalRateJob < ActiveJob::Base
  ...
  def perform
    ...
    published_messages.each do |message|
      ...
      message.calculate_website_goal_rate(message.message_generating.ip_exclusion_list)
      message.calculate_session_count(message.message_generating.ip_exclusion_list)
